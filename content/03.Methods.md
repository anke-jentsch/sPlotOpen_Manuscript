...
We considered 30 climatic and 7 soil variables. 
For climate, we complemented the 19 bioclimatic variables from CHELSA (@doi:10.1038/sdata.2017.122), namely :..... , as well as two variables reflecting growing-season warmth (growing degree days above 1 °C - GDD1 - and 5 °C - GDD5), which we calculated based on CHELSA bioclimatic variables. 
...
The eighteen plant functional traits were: (1) leaf area \[mm^2^\]; (2) stem specific density \[g cm^-3^\]; (3) specific leaf area \[m^2^kg^-1^\]; (4) leaf carbon concentration \[mg g^-1^\]; (5) leaf nitrogen concentration \[mg g^-1^\]; (6) leaf phosphorus concentration \[mg g^-1^\]; (7) plant height \[m\]; (8) seed mass \[mg\]; (9) seed longevity, isn't it?\[mm\]; (10) leaf dry matter content \[g g^-1^\]; (11) leaf nitrogen per area \[g m^-2^\]; (12) leaf N:P ratio \[g g^-1^\]; (13) leaf 𝛿^15^N \[per million\]; (14) seed number per reproductive unit; (15) leaf fresh mass \[g\]; (16) stem conduit density \[mm^-2^\]; (17) dispersal unit longevity\[mm\]; and (18) conduit element length \[μm\].  
